                ...
                return (
                  <div key={index} className="space-y-3 border-t border-stone-200 pt-3 first:border-t-0 first:pt-0">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      {type === "cloudmail_gen" || type === "cloudflare_temp_email" || type === "moemail" || type === "inbucket" || type === "yyds_mail" || type === "tempmail_self" || type === "ddg_mail" ? (
                        <>
                          <div className="space-y-2">
                    ...
                    {type === "cloudmail_gen" || type === "tempmail_lol" || type === "cloudflare_temp_email" || type === "moemail" || type === "inbucket" || type === "yyds_mail" || type === "tempmail_self" || type === "ddg_mail" ? (
                      <div className="space-y-2">
